...
lazy val root = (project in file(".")).settings(
  ...
  libraryDependencies ++= Seq(
    ...
    "org.typelevel" %% "cats-effect-std" % "3.2.4"$if(scala3.truthy)$$else$,
    // better monadic for compiler plugin as suggested by documentation
    compilerPlugin("com.olegpy" %% "better-monadic-for" % "0.3.1")$endif$$if(testlib-use-cats-effect-testing-specs2.truthy)$,
    "org.typelevel" %% "cats-effect-testing-specs2" % "1.2.0" % Test$else$$endif$$if(testlib-use-munit-cats-effect-3.truthy)$,
